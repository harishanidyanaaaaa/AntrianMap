    ...
    <body>
                            ...
                            <div class="white-box">
                                ...
                                <div class="card-body px-0 pb-0">
                                    <div class="table-responsive">
                                        ...
                                        <td>{{ $t->tanggal_transaksi }}</td>
                                        <td>{{ $t->tanggal_selesai }}</td>
                                    <td>  <img src="{{ asset('foto/'.$t->bukti_bayar) }}" alt="" style="width: 100px"></td>
        ...
        @method('PUT')
                            <div class="mb-3">
                                <input type="text" class="form-control" id="editNamaProduk{{$t->user_id}}" name="user_id" value="{{$t->user_id}}" >
                            </div>
                            <div class="mb-3">
        ...
        <form id="delete-form-{{$t->id}}" action="{{ route('Product-Delete', $t->id) }}" method="POST" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
                                        </td>
